...
export default {
  ...
  computed: {
    transform () {
      const formatType = this.valueFormat
      if (isPlainObject(formatType)) {
        return { ...transformDate.date, ...formatType }
      }
      ...
      return transformDate[formatType] || transformDate.date
    },
    ...
    inputPlaceholder () {
      ...
      return this.range ? this.getLocalValue('placeholder.dateRange') : this.getLocalValue('placeholder.date')
    },
